...
app.use(cors({
  origin: "https://job-haven-new-client.vercel.app",
  credentials: true,
}));
...
app.post("/api/signup", async (req, res) => {
  try {
    ...
    if (user) {
      ...
      await newUser.save();
      res.redirect(302, "https://job-haven-new-client.vercel.app");
  ...
  try {
    ...
    if (user) {
      ...
      if (passwordMatched) {
        ...
        // console.log(jwToken);
        res.redirect(302, "https://job-haven-new-client.vercel.app/jobfinder");
        return;
      } else {
        res.json({
          status: "FAIL",
